import urlwhiteEditController from './urlwhite.edit.controller';

export  default class UrlwhiteController {
    constructor(commonService, confirmDialog, $mdDialog) {
        this.commonService = commonService;
        this.confirmDialog = confirmDialog;
        this.$mdDialog = $mdDialog;
        this.baseUrl = 'rest/urlwhite';
   ...
   getListData() {
    ...
    showDialog(ev, rowData) {
        ...
        this.$mdDialog.show({
            controller: urlwhiteEditController,
            controllerAs: 'vm',
            template: require('./urlwhite.edit.tmpl.html'),
