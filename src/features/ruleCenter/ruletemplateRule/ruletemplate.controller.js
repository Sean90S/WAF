import RuletemplateEditCopyController from './ruletemplate.copy';

export  default class ruleTemplateController {
    constructor(commonService, confirmDialog, $mdDialog) {
        this.commonService = commonService;
        this.confirmDialog = confirmDialog;
        this.$mdDialog = $mdDialog;
        this.baseUrl = 'rest/ruleTemplate';
   ...
   getListData() {
    ...
    showDialog(ev, rowData) {
        ...
        this.$mdDialog.show({
            controller: RuletemplateEditCopyController,
            controllerAs: 'vm',
            template: require('./ruletemplate.edit.copy.tmpl.html'),
