import generalEditController from './general.edit.controller';
// import generalDialogController from './general.dialog.controller';
...
export  default class generalController {
    ...
    showDialog(ev, rowData) {
        ...
        this.$mdDialog.show({
            ...
            controllerAs: 'vm',
            template: require('./general.edit.tmpl.html'),
    ...
    deleteRecord(event, id) {
        this.confirmDialog.showConfirm(event, '删除记录', '确定执行删除操作吗？').then(() => {
            this.this.commonService.delete(this.baseUrl, id).then((response) => {
