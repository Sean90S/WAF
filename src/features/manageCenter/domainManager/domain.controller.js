...
export  default class DomainController {
    constructor(commonService, confirmDialog, $mdDialog) {
        ...
        //this.baseUrl = 'api/attacktype/queryAttackType';
    ...
    getListData() {
        this.baseUrl = 'api/domainmanage/queryDomain';
    ...
    deleteRecord(event, id) {
        ...
        const baseUrl = 'api/domainmanage/delDomain';
        this.confirmDialog.showConfirm(event, '删除记录', '确定执行删除操作吗？').then(() => {
            this.commonService.delete(baseUrl, id).then((response) => {
