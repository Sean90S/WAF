import BusinessEditController from './business.edit.controller';
...
export  default class BusinessController {
    constructor(commonService, confirmDialog, $mdDialog) {
        ...
        this.baseUrl = 'api/engGrp/queryEngGrp';
    ...
    showDialog(ev, rowData) {
        ...
        this.$mdDialog.show({
            ...
            controllerAs: 'vm',
            template: require('./business.edit.tmpl.html'),
    ...
    deleteRecord(event, id) {
        ...
        var delEngGrp = 'api/engGrp/delEngGrp';
        this.confirmDialog.showConfirm(event, '删除记录', '确定执行删除操作吗？').then(() => {

            this.commonService.save(delEngGrp, id).then((response) => {
